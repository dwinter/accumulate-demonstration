...
knitr::kable(denom_by_base, booktabs=TRUE, caption="Mutatoin rate denominators by base")
```
...
knitr::kable(comp, booktabs=TRUE, 
             caption="New accuMUlate mutations have a similar mutational spectrum to validate mutations")
```
...
knitr::kable(summ_table, caption="Summary of MA analysis by line", booktabs = TRUE)
